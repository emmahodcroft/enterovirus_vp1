...
if __name__ == '__main__':
    ...
    meta = meta.reindex(columns = ['orig_strain', 'virus', 'subgenogroup', 'accession', 'seq_len', 'date', 'age', 'host', 'genbank_host', 'country', 'moltype'])
    ...
    if args.regions:
        ...
        meta = meta.reindex(columns = ['orig_strain', 'virus', 'subgenogroup', 'accession', 'seq_len', 'date', 'age', 'host', 'genbank_host', 'country', 'region', 'moltype', 'strain'])
        newregion = []
